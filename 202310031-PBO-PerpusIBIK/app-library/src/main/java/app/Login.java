...
public class Login extends JFrame {
	...
	private void initialize(JFrame frmLoginPage) {
		...
		labelLogo.setIcon(new ImageIcon("C:\\Tugas Pa Feb\\ObjekOrientedProgramming\\Pertemuan10\\app-library\\src\\main\\java\\com\\ibik\\library\\images\\logo-ibik-web.png"));
		...
		btnSignIn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				} else if (inUser.equalsIgnoreCase("202310031") && inPass.equalsIgnoreCase("09112001")) { // kondisi jika username dan password benar
		...
		// menambahkan label untuk copyright
		JLabel lblNewLabel = new JLabel("(c) 2021 Arya Hirawansyah");
